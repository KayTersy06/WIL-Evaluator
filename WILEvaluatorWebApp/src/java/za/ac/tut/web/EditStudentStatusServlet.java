 ...
 * @author kayte
 */
public class EditStudentStatusServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String outcome1 = request.getParameter("mod1Otc");
            ...
            String outcome2 = request.getParameter("mod2Otc");
            ...
            String outcome3 = request.getParameter("mod3Otc");
            ...
            String outcome4 = request.getParameter("mod4Otc");
            ...
            student.setStatus(status);//default status
            student.setCreationDate(new Date());
            
            sfl.editStudent(student);
            
            RequestDispatcher disp = request.getRequestDispatcher("editwill_outcome.jsp");
            disp.forward(request, response);
        } catch (ParseException ex) {
            Logger.getLogger(EditStudentStatusServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
