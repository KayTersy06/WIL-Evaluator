...
public class EditStudentMarkServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher disp = request.getRequestDispatcher("editmarks_outcome.jsp");
            disp.forward(request, response);
        } catch (ParseException ex) {
            Logger.getLogger(EditStudentMarkServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
