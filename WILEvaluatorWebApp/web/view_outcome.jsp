<%-- 
    ...
    Created on : 23 May 2025, 11:29:34 PM
    Author     : kayte
--%>
...
<html>
    <head>
        ...
        <title>View Students By Status Outcome Page</title>
    </head>
    <body>
        <h1>View Students By Status Outcome</h1>
        <%
            String comp = application.getInitParameter("comp_name");
            List<Student> studList = (List<Student>)request.getAttribute("studList");
        %>
        <p>
            <%=comp%> here again, your information is below
        </p>
        <table>
            <%
